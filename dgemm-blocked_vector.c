...
#define BLOCK_SIZE_COLUMN 160
#define BLOCK_SIZE_2 576
#define BLOCK_SIZE_2_ROW 8
#define BLOCK_SIZE_2_COLUMN 32
...
static void do_block_vector (int lda, int M, int N, int K, double*  restrict A, double* restrict B, double* restrict C)
{
    // For each row i of A
...
static void do_vector (int lda, int ii, int jj, int kk, double* restrict A, double* restrict B, double* restrict C)
{
